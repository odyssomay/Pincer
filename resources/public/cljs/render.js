...
var filenames__163737 = render.fs.readdirSync(dir);
...
var merged_env__163738 = cljs.core.assoc.call(null,cljs.core.merge.call(null,cljs.core.PersistentHashMap.fromArrays([],[]),env),"\uFDD0'partials",util.map__GT_js.call(null,cljs.core.deref.call(null,render.partials)));
return util.map__GT_js.call(null,merged_env__163738);
});
...
var page_content__163739 = cljs.core.get.call(null,cljs.core.deref.call(null,render.pages),page,null);
var env__163740 = render.get_env.call(null,render.env);
if(cljs.core.not.call(null,page_content__163739))
{cljs.core.println.call(null,"WARNING: page",page,"does not exist");
} else
{}
return render.whiskers.render(page_content__163739,env__163740);
});
